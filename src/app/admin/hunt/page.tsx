...
export default async function AdminHuntIndexPage() {
  ...
  return (
    <div>
      <h1 className="text-xl font-semibold mb-1">Scavenger Hunt</h1>
      <p className="text-sm text-muted-foreground mb-6">
        Manage scavenger hunts, clues, and leaderboards for your events.
      </p>
