...
export default async function AdminHackathonsPage() {
  ...
  return (
    <div>
      <h1 className="text-xl font-semibold mb-1">Hackathons</h1>
      <p className="text-sm text-muted-foreground mb-6">Select a hackathon to manage judging, teams, and bracket.</p>
            ...
            >
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  {new Date(ev.starts_at).toLocaleDateString('en-CA', { year: 'numeric', month: 'short', day: 'numeric' })}
                </p>
              </div>
